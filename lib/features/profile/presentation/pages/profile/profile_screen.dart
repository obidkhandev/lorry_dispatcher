...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        children: [
          ...
          Text(
            ...
            style: context.theme.textTheme.displayMedium?.copyWith(
              fontSize: 12.sp,
              color: context.theme.textTheme.displayMedium?.color?.withOpacity(
                0.7,
              ),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => inject<ProfileBloc>()..add(GetProfileEvent()),
      child: Scaffold(
            ...
            SliverToBoxAdapter(
              child: DecoratedBox(
                ...
                child: ProfileSection(
                  title: S
                      .of(context)
                      .balanceAndRating, // Replaced "Balance and rating"
                  actions: [
                    ProfileActionModel(
                ...
                child: BlocBuilder<SettingsCubit, SettingsState>(
                  builder: (context, state) {
                    return ProfileSection(
                      title: S
                          .of(context)
                          .settings, // Already using S.of(context).settings
                      actions: [
                        ProfileActionModel(
                        ...
                        ProfileActionModel(
                          ...
                          // Already using S.of(context).theme
                          icColor: AppColors.white,
                          onTap: () async {
                ...
                child: ProfileSection(
                  ...
                  actions: [
                    ProfileActionModel(
                      title: S
                          .of(context)
                          .privacyPolicy, // Replaced "privacy_policy"
                      icColor: AppColors.white,
                      onTap: () async {
            ...
            SliverToBoxAdapter(
              child: DecoratedBox(
                ...
                child: ProfileSection(
                  title: S
                      .of(context)
                      .deleteAndLogout, // Replaced "Delete and logout"
                  actions: [
                    ProfileActionModel(
                      ...
                      onTap: () {
                        CustomYesNoDialog(
                          ...
                          title: S
                              .of(context)
                              .confirmLogout, // Already using S.of(context).confirmLogout
                        ).show(context);
                      },
                      icColor: AppColors.white,
                    ...
                    ProfileActionModel(
                      title: S
                          .of(context)
                          .deleteAllProfiles, // Replaced "delete_all_profiles"
                      icColor: AppColors.white,
